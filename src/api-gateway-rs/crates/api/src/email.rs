...
<table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:14px;overflow:hidden;max-width:480px;width:100%;">
  <tr><td style="background:#0A1622;padding:24px 32px;">
    <table role="presentation" cellpadding="0" cellspacing="0"><tr>
      <td style="width:28px;height:28px;background:#2B7FB8;border-radius:8px;text-align:center;vertical-align:middle;font-size:14px;">🛡️</td>
  ...
  <tr><td style="padding:36px 32px 28px;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0"><tr>
      <td style="background:#2B7FB8;border-radius:999px;">
        <a href="{cta_url}" style="display:inline-block;padding:13px 28px;color:#FFFFFF;font-weight:700;font-size:15px;text-decoration:none;">{cta_text}</a>
      </td>
    </tr></table>
